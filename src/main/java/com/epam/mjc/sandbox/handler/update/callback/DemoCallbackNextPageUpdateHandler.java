...
@Component
public class DemoCallbackNextPageUpdateHandler
    extends CallbackUpdateHandler<DemoCallbackNextPageDto> {
  ...
  @Override
  protected Class<DemoCallbackNextPageDto> getDtoType() {
    return DemoCallbackNextPageDto.class;
  }

  @Override
  protected SerializableInlineType getSerializableType() {
    return SerializableInlineType.NEXT_PAGE;
  }

  @Override
  protected void handleCallback(Update update, DemoCallbackNextPageDto dto)
    ...
    if (page == 1) {
      pagination.add(
          InlineKeyboardButton.builder()
              ...
              .callbackData(
                  StringUtil.serialize(new AlertDto("Page " + page + " from " + MAX_PAGE, false)))
              .build());
      pagination.add(
          InlineKeyboardButton.builder()
              .text("▶")
              .callbackData(StringUtil.serialize(new DemoCallbackNextPageDto(page + 1)))
              .build());
